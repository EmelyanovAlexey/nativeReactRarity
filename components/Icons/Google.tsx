  ...
  return (
    <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M23.5202 12.2729C23.5202 11.422 23.4439 10.6038 23.3021 9.81836H12.0002V14.4602H18.4584C18.1802 15.9602 17.3348 17.2311 16.0639 18.082V21.0929H19.9421C22.2112 19.0038 23.5202 15.9274 23.5202 12.2729Z"
        fill="#4285F4"
      />
      <Path
        fillRule="evenodd"
